...
{
    internal sealed class GetSportsCenterWorkingHoursForWeekHandler : IRequestHandler<GetSportsCenterWorkingHoursForWeek, IEnumerable<SportsCenterWorkingHoursDto>>
    {
        private readonly SportsCenterDbContext _dbContext;

        public GetSportsCenterWorkingHoursForWeekHandler(SportsCenterDbContext dbContext)
        {
            _dbContext = dbContext;
        }

        public async Task<IEnumerable<SportsCenterWorkingHoursDto>> Handle(GetSportsCenterWorkingHoursForWeek request, CancellationToken cancellationToken)
        {
