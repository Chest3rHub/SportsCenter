    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <SmallGreenHeader width={'22%'}>{dictionary.reservationsPage.clientEmailLabel}</SmallGreenHeader>
                    <SmallGreenHeader width={'14%'}>{dictionary.reservationsPage.courtLabel}</SmallGreenHeader>                        
                    <SmallGreenHeader width={'16%'}>{dictionary.reservationsPage.dateLabel}</SmallGreenHeader>
                    <SmallGreenHeader width={'16%'}>{dictionary.reservationsPage.timeLabel}</SmallGreenHeader>
                    <SmallGreenHeader width={'10%'}>{dictionary.reservationsPage.isEquipmentReservedLabel}</SmallGreenHeader>
                    <SmallGreenHeader width={'18%'}>{dictionary.reservationsPage.statusLabel}</SmallGreenHeader>
                </Box>
                ...
                >
                    ...
                    >
                        ...
                        >
                            <Typography>
                                {reservation.isEquipmentReserved ? dictionary.reservationsPage.yesLabel : dictionary.reservationsPage.noLabel}
                            </Typography>
                        </Box>
                    ...
                    <ReservationButton backgroundColor={"#f0aa4f"} onClick={() => handleShowMoreInfo(reservation.reservationId)} minWidth={'6vw'}>
                            {dictionary.reservationsPage.moreInfoLabel}
                    </ReservationButton>
                    <ReservationButton backgroundColor={"#F46C63"} onClick={() => handleOpenModal(reservation)} disabled={!canCancelOrMoveReservation(reservation)} minWidth={'6vw'}>
            ...
            >
                ...
                >
                    ...
                    <Box sx={{ display: 'flex', gap: '3rem', marginTop: '1rem' }}>
                        <GreenButton onClick={handleCloseModal} style={{ maxWidth: "10vw", backgroundColor: "#F46C63", minWidth: '7vw' }} hoverBackgroundColor={'#c3564f'}>{dictionary.reservationsPage.noLabel}</GreenButton>
                        <GreenButton onClick={() => { handleCancelReservation(selectedReservation.clientEmail, selectedReservation.reservationId) }} style={{ maxWidth: "10vw", minWidth: '7vw' }}>{dictionary.reservationsPage.yesLabel}</GreenButton>
                    </Box>
                </Box>
            </Modal>
            {<Box sx={{
                ...
                <ChangePageButton disabled={offset === 0} onClick={handlePreviousPage} backgroundColor={"#F46C63"} minWidth={"10vw"}>{dictionary.reservationsPage.previousLabel}</ChangePageButton>
                <ChangePageButton disabled={reservations.length < reservationsRequiredToEnablePagination} onClick={handleNextPage} backgroundColor={"#8edfb4"} minWidth={"10vw"}>{dictionary.reservationsPage.nextLabel}</ChangePageButton>
            </Box>}
        </Box>
        </>
    );
