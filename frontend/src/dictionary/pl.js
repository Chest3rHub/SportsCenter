...
export default {
  ...
  addClientDiscountPage: {
    ...
    activityDiscountError: 'Wartość zniżki na zajęcia musi być większa niż 0 i mniejsza lub równa 100',
    productDiscountLabel: 'Wysokość zniżki na produkty w %',
    productDiscountError: 'Wartość zniżki na produkty musi być większa niż 0 i mniejsza lub równa 100',
    returnLabel: 'Wróć',
    saveLabel: 'Zapisz',
    successLabel: 'Sukces!',
    savedSuccessLabel: 'Udało się zapisać zmiany!',
  ...
  addActivityPage: {
    ...
    employeeIdLabel: 'Trener',
    employeeIdError: 'Niepoprawny trener',
