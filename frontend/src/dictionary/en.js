export default {
  ...
  clientsPage: {
    ...
    giveDiscountLabel: 'discount',
    addDepositLabel: 'deposit',
  ...
  addClientDiscountPage: {
    ...
    activityDiscountError: 'The activity discount must be greater than 0 and lower or equal to 100',
    productDiscountLabel: 'Product Discount Amount in %',
    productDiscountError: 'The product discount must be greater than 0 and lower or equal to 100',
    returnLabel: 'Back',
    saveLabel: 'Save',
    successLabel: 'Success!',
    savedSuccessLabel: 'Changes saved successfully!',
...
reservationsSummaryPage: {
  ...
  addActivityPage: {
    ...
    employeeIdLabel: 'Coach',
    employeeIdError: 'Invalid coach',
